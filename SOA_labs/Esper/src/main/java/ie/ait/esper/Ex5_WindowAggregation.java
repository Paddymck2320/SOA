 ...
 * @author A00261481
 */
public class Ex5_WindowAggregation {
    ...
    public static void main(String args[]){
        ...
        String epl = "select count(*) as total from PersonEvent(age >= 50)";
        ...
        statement.addListener( (newData, oldData) -> {
            ...
            System.out.println(String.format("Count: %d, AvgAge of Last: %d", total, sumAge));
        });
